         ...
         <li class='<?php echo $article->id?>'> 
           ...
           <img id="loader-identity" src="JS/ajax-loader.gif" alt="gif">
            ...
            <ul class="ajax-load">
                ...
                <li><a href=".?action=viewArticle&amp;articleId=<?php echo $article->id?>" class="ajaxPost" data-contentId="<?php echo $article->id?>">(POST) -- NEW</a></li>
                <li><a href=".?action=viewArticle&amp;articleId=<?php echo $article->id?>" class="ajaxGet" data-contentId="<?php echo $article->id?>">(GET)  -- NEW</a></li>
            </ul>
